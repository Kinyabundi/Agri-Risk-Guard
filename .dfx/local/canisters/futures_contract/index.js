...
export const canisterId = process.env.FUTURES_CONTRACT_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./futures_contract.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the futures_contract canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./futures_contract.did.js")._SERVICE>}
 */
export const futures_contract = createActor(canisterId);
