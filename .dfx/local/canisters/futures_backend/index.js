...
import { idlFactory } from './futures_backend.did.js';
export { idlFactory } from './futures_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.FUTURES_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./futures_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the futures_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./futures_backend.did.js")._SERVICE>}
 */
export const futures_backend = createActor(canisterId);
